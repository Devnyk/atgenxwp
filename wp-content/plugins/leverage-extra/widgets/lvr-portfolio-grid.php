...
class LVR_Portfolio_Grid extends Widget_Base {

  public function get_name() {
    return 'leverage-portfolio-grid';
  }

  public function get_title() {
    return __( 'Portfolio Grid', 'leverage-extra' );
  }
  ...
  protected function _register_controls() {
		...
		add_post_item_content_control( $this, 'portfolio' );
				...
				<div class="row justify-content-center items filter-items">
					...
					if ( $query->have_posts() ) {
						while ( $query->have_posts() ) {
							...
							$item_filter_categories = get_the_terms( get_the_ID(), 'leverage_portfolio_category' );
