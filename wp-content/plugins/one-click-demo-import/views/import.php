			...
			<div class="ocdi__content-container-content--main">
								...
								<div class="ocdi-content-notice ocdi-content-notice--warning">
									<p>
										<?php
											...
											printf(
												esc_html__(
													'If you are going to use Elementor it is very important that you disable Default Colors and Default Fonts in the %5$s so that you get the look of the theme. %7$s The %1$s of the theme will be replaced by the design of the selected demo.%7$s %2$s and %3$s will be imported as long as you have not yet configured them. %7$s Posts, pages, images, videos, widgets, menus and other theme settings will get imported and set as the Homepage and Posts Page in %4$s. No data will be removed and you can import as many times as you like. %7$s Import errors are caused by your web server\'s inability. See %6$s for more details.',
													'one-click-demo-import'
												),
												'<a href="' . esc_url( admin_url( 'admin.php?page=theme-settings-design' ) ) . '" target="blank">' . esc_html( 'Design & Color' ) . '</a>',
												'<a href="' . esc_url( admin_url( 'admin.php?page=theme-settings-form' ) ) . '" target="blank">' . esc_html( 'Forms' ) . '</a>',
												'<a href="' . esc_url( admin_url( 'admin.php?page=theme-settings-footer' ) ) . '" target="blank">' . esc_html( 'Footer' ) . '</a>',
												'<a href="' . esc_url( admin_url( 'options-reading.php' ) ) . '" target="blank">' . esc_html( 'Reading Settings' ) . '</a>',
												'<a href="' . esc_url( admin_url( 'admin.php?page=elementor' ) ) . '" target="blank">' . esc_html( 'Elementor Settings' ) . '</a>',
												'<a href="' . esc_url( 'https://ocdi.com/import-issues' ) . '" target="blank">' . esc_html( 'Import Issues' ) . '</a>',
												'<br><br>'
											);
										?>
									</p>
				...
				<div class="ocdi-imported js-ocdi-imported">
					...
					<div class="ocdi-imported-footer">
						<!-- Leverage -->
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=theme-settings-branding' ) ); ?>" class="button button-primary button-hero"><?php esc_html_e( 'Theme Settings' , 'one-click-demo-import' ); ?></a>
						<a href="<?php echo esc_url( admin_url( 'options-reading.php' ) ); ?>" class="button button-primary button-hero"><?php esc_html_e( 'Set the Home Page' , 'one-click-demo-import' ); ?></a>
