	...
	<div class="ocdi__content-container">
		...
		<div class="ocdi__intro-text">
			<p class="about-description">
				<!-- Leverage -->
				<?php esc_html_e( 'Importing demo data (post, pages, images, theme settings, etc.) is the quickest and easiest way to set up your new website. It allows you to simply get everything instead of creating content and layouts from scratch.' ); ?>
			</p>
			<p class="about-description">
				<!-- Leverage -->
				<?php esc_html_e( 'You can choose Elementor Demos to have more customization control or Classic Demos to not need additional plug-ins and have your website faster.', 'one-click-demo-import' ); ?>
			</p>
		</div>
