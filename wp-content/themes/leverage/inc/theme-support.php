...
function leverage_widgets_init() {	
	register_sidebar( 
		array(
			...
			'before_widget' => '<div id="%1$s" class="row item widget-blog-sidebar widget %2$s""><div class="col-12 p-0 align-self-center">',
	...
	register_sidebar(
		array(
			...
			'id'            => 'page-sidebar',
			'description'   => esc_html__( 'Add widgets here.', 'leverage' ),
			'before_widget' => '<div id="%1$s" class="row item widget-page-sidebar widget %2$s""><div class="col-12 p-0 align-self-center">',
			'after_widget'  => '</div></div>',
			'before_title'  => '<h4 class="title">',
			'after_title'   => '</h4>',
		)
...
function leverage_register_elementor_locations( $elementor_theme_manager ) {	
	$elementor_theme_manager->register_location( 'comments' );
}
add_action( 'elementor/theme/register_locations', 'leverage_register_elementor_locations' );

function leverage_time_ago() {
	return human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) );
}

function leverage_author_display_name() {
...
function leverage_translate( $text ) {
